...
const AuthForm: React.FC<AuthFormProps> = ({ type }) => {
  ...
  return (
    <form
      ...
      className="w-full max-w-md  p-8 mx-auto mt-12 bg-bgSecondaryLight dark:bg-bgSecondaryDark text-textPrimaryLight dark:text-textPrimaryDark border border-bgPrimaryDark dark:border-textSecondaryDark rounded-2xl shadow-xl"
    >
